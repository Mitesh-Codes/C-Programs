...
{
    float area=3.14159*distance(x1, y1, x2, y2)*distance(x1, y1, x2, y2);
...
int main()
{
    ...
    area1=areaOfCircle(x1, y1, x2, y2, Edistance);
    
    printf("The area of circle whose radius is %f =%f",dst,area1);
    return 0;
}
